    ...
    public partial class MyEvents : System.Web.UI.Page
    {
        ...
        private void GetEvents()
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                string countQuery = $"SELECT COUNT(*) FROM Attendees WHERE UserId={userId}";
        ...
        protected void UserRepeater_ItemCommand(object source, RepeaterCommandEventArgs e)
        {
            ...
            }else if(e.CommandName == "CancelEventRegister")
            {
                int eventId = Convert.ToInt32(e.CommandArgument);
        ...
        private void UnRegisterEvent(int userId, int eventId)
        {
            try
            {
                using (SqlConnection con = new SqlConnection(cs))
                {
                    SqlCommand cmd = new SqlCommand("UnRegisterEvent", con);
                    ...
                    con.Open();
                    cmd.ExecuteNonQuery();
                    Page.ClientScript.RegisterStartupScript(this.GetType(), "Scripts", "<script>alert('Event unregistration successful!')</script>");
        ...
        protected void UserRepeater_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                if (IsUserRegisteredForEvent(userId, eventId))
                {
                    ...
                    Button cancelEventRegister = (Button)e.Item.FindControl("CancelEventRegister");
                    cancelEventRegister.Visible = true;
                ...
                else
                {
                    ...
                    Button cancelEventRegister = (Button)e.Item.FindControl("CancelEventRegister");
                    cancelEventRegister.Visible = false;
